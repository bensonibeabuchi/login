...
export default function page() {
  return (    
    <div>
      <div className='bg-background3 bg-cover h-screen flex justify-center items-center'>
        <div className='bg-gradient-to-b from-[#E2ECFE] from-85% to-[#9EA8FA] to-100% w-96 overflow-clip rounded-3xl shadow-lg h-4/5 border'>
          <div className='h-3/6 text-white flex justify-center items-center'>
            <Image src={logo2} alt='logo' width={200}/>
          </div>
          <div className='grid place-content-center h-3/6'>
            <div className='grid absolute place-content-center w-96'>
                ...
                <div className='text-[#5363f3]  text-sm mt-8 w-64 text-center'>
                ...
                <div className='grid place-content-center'>
                    <div className='relative flex items-center'>
                        ...
                        id="email"
                        placeholder='Email'
                        className='placeholder-[#AFAFAF] shadow-sm shadow-[#9EA8FA] my-2 w-72 rounded-full text-[#2B40F4] border-2 p-2 pl-8 border-[#9EA8FA]'/>
                    </div>
                    ...
                    {/* <div className='relative flex items-center'>
                        ...
                        className='placeholder-[#AFAFAF] shadow-sm shadow-[#9EA8FA] my-2 w-72 rounded-full border-2 p-2 pl-8 border-[#9EA8FA]'/>
                ...
                <div className='text-[#2B40F4] mt-16 font-semibold grid place-content-center justify-center'>
                    ...
                    <div className='bg-[#2B40F4] h-1 rounded-full w-48 mb-2'></div>
                </div>
