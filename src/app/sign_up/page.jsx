...
export default function page() {
  return (    
    <div>
      <div className='bg-background2 bg-cover h-screen flex justify-center items-center'>
          ...
          <div className='grid place-content-center h-3/6'>
            <div className='grid absolute place-content-center w-96'>
                ...
                <div className='m-auto'>
                    <div className='bg-[#2B40F4] h-1 rounded-full w-64 items-center'>
                        <div className='bg-[#B5D3FD] h-1 rounded-l-full w-32'></div>
                    </div>
                </div>
